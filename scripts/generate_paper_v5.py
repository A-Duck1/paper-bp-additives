...
add_para("[13] Hu, J. et al. Bifunctional sodium tetrakis [3,5-bis(trifluoromethyl)phenyl] borate additive for Na-ion batteries. Chem. Eng. J. 505, 162144 (2025). DOI: 10.1016/j.cej.2025.162144")
...
add_para("[16] Das, S. & Chakraborty, S. Machine learning prediction of physicochemical properties in lithium-ion battery electrolytes with active learning applied to graph neural networks. J. Comput. Chem. 46, 70009 (2025). DOI: 10.1002/jcc.70009")
